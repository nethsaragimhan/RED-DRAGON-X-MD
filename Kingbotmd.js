...
module.exports = KingmdWH = async (KingmdWH, m, chatUpdate, store) => {
	...
	//group target \\
const reply = (teks) => {
            KingmdWH.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botname}`,"body": ` Gojo-Satoru`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./KINGMedia/logo.jpeg`),"sourceUrl": "https://telegra.ph/file/8bbe8a7de5c351dfcb077.jpg"}}}, { quoted: m})
        }
	    ...
	    case 'family100': {
            ...
            case 'guess': {
                ...
                if (args[0] === "song") {
                    ...
                    let anu = await fetchJson('https://raw.githubusercontent.com/whitehackers/fungames/main/GuessTheWord.js')
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    ...
                    let anu = await fetchJson('https://raw.githubusercontent.com/whitehackers/fungames/main/GuessTheSentence.js')
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    KingmdWH.sendText(m.chat, `Please Answer The Following Question\n\n${result.soal}\nTime : 60 seconds`, m).then(() => {
...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
    ...
    case 'donasi': case 'donate': case 'sewabot': case 'sewa': {
            ...
            break
            case 'sc': case 'script': {
                reply(`GitHub : https://github.com/whitehackers/Gojo-Satoru\n Dont Forget To Give Star\n\nYouTube : ${myweb}\nDont Forget To Watch Tutorial`)
            }
            break
case 'allmenu': {
  	anu = `
